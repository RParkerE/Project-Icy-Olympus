...
// found this somewhere. food for thought?
            ...
            <Box
                ...
                <Box background={"rgba(236, 246, 253,1)"} height="100%"
                    ...
                    <Container
                        ...
                        pb={16}
                    >
                        <Heading size="lg">Charlie Kelly</Heading>
                        <Box
                            ...
                            <Box
                                ...
                                <Box zIndex="1" width="100%" position="absolute" height="100%">
                                    <Box
                                        // maybe find a cute bar background here
                            ...
                            <Box
                                ...
                                <Tags tags={['Local', 'Dancing', 'Rooftop']} />
                                ...
                                {/* Keeping this so we can brainstorm longer layouts */}
                                {/* <Text
                                    as="p"
                                    marginTop="2"
